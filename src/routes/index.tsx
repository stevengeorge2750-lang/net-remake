...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ComeOnLetXFixIt — IT Infrastructure, Fixed Right" },
      {
        name: "description",
        content:
          "A senior IT consultancy that diagnoses, optimizes, and modernizes the systems your business runs on.",
      },
    ],
  }),
  component: Index,
    ...
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2 group">
          <span className="w-7 h-7 rounded-sm bg-primary text-primary-foreground grid place-items-center font-mono text-sm font-bold">
            X
          </span>
          <span className="font-display text-lg tracking-tight">
            ComeOnLet<span className="text-primary">X</span>FixIt
          </span>
        </a>
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-sm bg-primary text-primary-foreground hover:opacity-90 transition-opacity"
        >
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-12 items-end">
        <div className="lg:col-span-7">
          ...
          <h1 className="text-display text-[clamp(3rem,8vw,7.5rem)] text-foreground">
            Fix it.{" "}
            <span className="italic font-light text-muted-foreground">Enhance it.</span>
            <br />
            Elevate the<br />
            whole <span className="text-primary italic font-light">stack.</span>
          </h1>
          <p className="mt-10 max-w-xl text-lg text-muted-foreground leading-relaxed">
            A senior IT consultancy for businesses that can't afford downtime, dead weight,
            or duct-tape architecture. We diagnose, optimize, and modernize the systems your
            company runs on.
          </p>
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <a
              href="#services"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-sm bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity"
            >
              See what we fix <ArrowUpRight className="w-4 h-4" />
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-sm border border-border-strong text-foreground hover:bg-surface transition-colors"
            >
              Talk to an engineer
            </a>
          </div>
        ...
        <div className="lg:col-span-5 relative">
          <div className="relative aspect-[4/5] overflow-hidden rounded-sm border border-border">
            <img
              src={heroImage}
              alt="Glowing network infrastructure"
              width={1600}
              height={1200}
          ...
          <div className="absolute -bottom-6 -left-6 bg-surface border border-border-strong rounded-sm p-5 max-w-[220px] shadow-[var(--shadow-card)]">
            ...
            <p className="font-display text-4xl">
              17<span className="text-primary">m</span>
            </p>
    ...
    <section id="about" className="py-24 lg:py-40">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-16">
        <div className="lg:col-span-4">
          ...
          <h2 className="text-display text-5xl lg:text-6xl">
            Built for the businesses everyone else gave up on.
          </h2>
        </div>
        <div className="lg:col-span-7 lg:col-start-6 space-y-8">
          <p className="text-xl leading-relaxed text-foreground/90">
            ComeOnLetXFixIt is a trusted IT partner for teams who need their technology
            to just work — and need it to work better than it did yesterday.
          </p>
          <p className="text-base leading-relaxed text-muted-foreground">
            We sit between the urgent ticket and the long-term roadmap. Whether you need
            an unrecoverable server rescued before close of business, a network rebuilt
            for a hundred new hires, or a strategy that takes your stack from legacy to
            leading — our engineers fix, enhance, and elevate.
          </p>
          <div className="grid grid-cols-3 gap-6 pt-8 border-t border-border">
            {[
              { n: "14+", l: "Years in the field" },
              { n: "300+", l: "Networks under care" },
  ...
  const services = [
    {
      ...
      desc: "Rapid diagnosis and resolution. Hardware failures, software conflicts, mystery outages — we get you back online before your team finishes their coffee.",
      img: supportImage,
      tags: ["Helpdesk", "On-site", "Remote"],
    },
    {
      n: "02",
      icon: Gauge,
      title: "Optimization & Performance",
      desc: "We audit your stack end-to-end, find the bottlenecks, kill the bloat, and tune systems so your infrastructure earns its keep.",
      img: optimizeImage,
      tags: ["Audit", "Network", "Cloud cost"],
    },
    {
      n: "03",
      icon: Compass,
      title: "Strategic Planning & Consulting",
      desc: "From cloud migrations to security posture to a five-year roadmap — we align your technology with where the business is actually going.",
      img: strategyImage,
      tags: ["Roadmap", "Migration", "Security"],
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          <div>
            ...
            <h2 className="text-display text-5xl lg:text-7xl max-w-2xl">
              Three disciplines. <span className="italic text-muted-foreground">One standard.</span>
            </h2>
          </div>
          <p className="max-w-md text-muted-foreground">
            Pick what you need today. Engage us for the next ten years. Either works.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-px bg-border">
          {services.map((s) => (
            <article
              key={s.n}
              className="group relative bg-background p-8 lg:p-10 flex flex-col hover:bg-surface transition-colors"
            >
              ...
              <div className="flex flex-wrap gap-2 pt-6 border-t border-border">
                {s.tags.map((t) => (
                  <span key={t} className="text-xs font-mono text-muted-foreground px-2 py-1 border border-border rounded-sm">
                    {t}
                  </span>
                ))}
              </div>
  ...
  return (
    <section id="process" className="py-24 lg:py-40">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <h2 className="text-display text-5xl lg:text-7xl mb-16 max-w-3xl">
          How we work.
        </h2>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-16">
        <div className="lg:col-span-5">
          ...
          <h2 className="text-display text-5xl lg:text-7xl mb-8">
            Something<br /> <span className="italic text-primary">broken?</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-12 max-w-md">
            Tell us what's on fire. We'll reply within one business hour — usually faster.
          </p>
        ...
        <form
          ...
          className="lg:col-span-6 lg:col-start-7 bg-background border border-border rounded-sm p-8 lg:p-10 space-y-6"
        >
          <div>
            <label className="text-eyebrow block mb-3">Name</label>
            <input
              required
              className="w-full bg-transparent border-b border-border-strong py-3 focus:outline-none focus:border-primary transition-colors"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              rows={4}
              required
              className="w-full bg-transparent border-b border-border-strong py-3 focus:outline-none focus:border-primary transition-colors resize-none"
            />
          </div>
          <button
            type="submit"
            disabled={sent}
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-sm bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity disabled:opacity-60"
          >
    ...
    <footer className="border-t border-border py-12">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <p className="font-mono text-xs text-muted-foreground">
          © {new Date().getFullYear()} — Fix, enhance, elevate.
        </p>
      </div>
    </footer>
  );
